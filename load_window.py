...
def load_window(indoor_temp, w_alpha, w_beta, Ago, k=0.85, tau=0.48, Bn=0.12, K=4):
    # 输入室内温度
    #indoor_temp = 26
    # 窗户尺寸
    #Ago = 3.6
    ...
    #K = 4.0
    # 直达日射 扩散日射 反射日射 夜间放射
    [I_D, I_s, I_r, cos_theta, Fs, weather_data] = solar_radiation.solar_radiation_for_load_window(w_alpha, w_beta = w_beta)
